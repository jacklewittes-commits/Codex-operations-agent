...
5. Plane transport trucks need one team person total unless the PM explicitly asks for more.
...
- Any משאית bringing a plane down gets one team person total, and that person cannot also ride in another car for that trip.
...
- At `בקתה ערבה - נוני`, prefer one person per available room before pairing people in a room.
