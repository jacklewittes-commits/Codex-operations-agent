...
This context was extracted from April 2026 weekly plans and PM clarification.

## Hebrew terms
- `טנדר` means pickup truck.
- `נגרר` means trailer.
...
- Always ask or infer which vehicles are active for the specific week.
- Do not assume all company cars are active.
- Do not attach a trailer to a pickup unless the weekly context says the trailer is needed or attached.
- Any attached trailer requires a trailer-licensed driver/commander.
